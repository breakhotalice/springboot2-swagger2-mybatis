package com.snoopy.controller.casemodule;
...
public class CaseUserController {
    ...
    public @ResponseBody DataResult<UserDomain> findAllUser(@RequestParam(name = "pageNum", required = false, defaultValue = "1") int pageNum,
